...
const translations = {
  en: {
    ...
    'airdrop.stats': 'Already Received',
    'airdrop.stats.people': 'people',
    'airdrop.deadline': 'Airdrop ends at the end of this month',
    'airdrop.deadline.urgent': 'Hurry up! Limited time offer',
    'airdrop.steps.title': 'How to Claim',
    'airdrop.step1': 'Follow us on X (Twitter)',
    'airdrop.step2': 'Join our Telegram group',
    'airdrop.step3': 'Submit your wallet address',
    'airdrop.step1.desc': 'Follow @EGIRL_BSC',
    'airdrop.step2.desc': 'Join the community',
    'airdrop.step3.desc': 'Leave your address',
    'airdrop.quick.actions': 'Quick Actions',
  ...
  zh: {
    ...
    'airdrop.join': '加入电报群',
    'airdrop.stats': '已有',
    'airdrop.stats.people': '人获得了空投奖励',
    'airdrop.deadline': '空投截至本月底',
    'airdrop.deadline.urgent': '抓紧时间！限时优惠',
    'airdrop.steps.title': '空投流程',
    'airdrop.step1': '关注 X (Twitter)',
    'airdrop.step2': '进入电报群',
    'airdrop.step3': '留下钱包地址',
    'airdrop.step1.desc': '关注 @EGIRL_BSC',
    'airdrop.step2.desc': '加入社区',
    'airdrop.step3.desc': '留下地址即可',
    'airdrop.quick.actions': '快速操作',
    'buy.now': '立即购买 EGIRL',
    'buy.now.short': '立即购买',
    'learn.more': '了解更多',
    'price': '当前价格',
